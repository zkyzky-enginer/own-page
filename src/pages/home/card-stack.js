  ...
  return (
    <div className="card-stack-container" ref={containerRef}>
			{cards.map((card, index) => (
				...
				>
					<div className={`stack-desc flex flex-col w-[25%] h-full leading-[22px] justify-center p-[2rem] bg-[${card.color || '#FF8C0046'}]`}>
					...
					<div className={`flex-1 w-full h-full relative bg-[${card.color || '#FF8C0016'}] p-[2rem]`}>
						{/* 引入porject-img下的图片 */}
